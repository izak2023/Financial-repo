...
csv_file_path = "C:\\Users\\HP\\Downloads\\financial folders\\fin.csv"

# Load data
data = load_data(csv_file_path)

# Display the data in a table
st.write("### financial folders")
st.write(data)
...
echo "# Financial-repo" >> README.md
git init
git add README.md
git commit -m "first commit"
git branch -M main
git remote add origin https://github.com/izak2023/Financial-repo.git
